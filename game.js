  ...
  for (let i = 0; i < threats.length; i++) {
    ...
    if (threat.type == "Pellet") {
      ...
      if (threat.start[0] !== threat.end[0]) {
        let slope =
          (threat.start[1] - threat.end[1]) / (threat.start[0] - threat.end[0]);
        ...
        if (threat.start[0] <= this.x + 10 && threat.start[0] >= this.x - 10) {
          state.gameLose();
        }
      }
    }
...
State.prototype.update = function () {
  ...
  for (let i = 0; i < this.threats.length; i++) {
    let threat = this.threats[i];
    if (threat.update() == null) this.threats[i] = null;
  }
  ...
  if (this.currentAttackDuration >= 0) {
    ...
    if (this.currentAttackInterval <= 0) {
      this.threats = this.threats.concat(
        this.currentAttackFunction(this.player)
      );
...
State.prototype.gameWin = function () {
  ...
  if (gameWinProgress <= 255) {
    ...
    document.getElementById("rick").width = Math.floor(
      (1 - gameWinProgress / 255) * 181
    );
    document.getElementById("rick").height = Math.floor(
...
var attacks = [
  ...
  [
    function (player) {
      return [
        new Laser(player.x, 0, player.x, 500, 2000, 100),
  ...
  [
    function (player) {
      counter1--;
      return [
        new Laser(0, 50 * counter1, 1000, 50 * counter1, counter1 * 200, 2500),
      ];
    },
    100,
    2000,
  ...
  [
    function (player) {
      counter2--;
      return [
        new Laser(50 * counter2, 0, 50 * counter2, 500, counter2 * 100, 500),
      ];
    },
    50,
    2000,
  ...
  [
    function (player) {
      if (counter3) {
        counter3 = 0;
        return [
          new Laser(0, 0, 1000, 500, 500, 200),
          new Laser(0, 500, 1000, 0, 500, 200),
        ];
      } else {
        counter3 = 1;
        return [
          new Laser(500, 0, 500, 500, 500, 200),
          new Laser(0, 250, 1000, 250, 500, 200),
        ];
      }
    },
    500,
  ...
  [
    ...
    750,
    1500,
  ], // Initialize Cross Laser in Middle
  [
    function (player) {
      return [
        new Pellet(0, 0, [
  ...
  [
    ...
    750,
    1500,
  ], // Initialize Diagonal Cross Laser in Middle
  [
    function (player) {
      return [
        new Pellet(0, 0, [
  ...
  [
    ...
    100,
    1000,
  ], // Initialize Counter 1 + Counter 2 + Break
  [
    function (player) {
      counter1--;
      counter2--;
  ...
  [
    function (player) {
      return [
        new Pellet(Math.floor(Math.random() * 1000), 0, [0, 3]),
  ...
  [
    function (player) {
      return [
        new Pellet(Math.floor(Math.random() * 1000), 500, [0, -3]),
  ...
  [
    function (player) {
      ...
      let y = Math.sin(angle) * 1500;
      return [
        new Laser(0, 0, Math.floor(x1), Math.floor(y), 1000, 250),
  ...
  [
    ...
    1250,
    1500,
  ], // Initialize Cross Laser + Diagonal Cross Laser in Middle
  [
    function (player) {
      return [
        new Pellet(0, 0, [
  ...
  [
    function (player) {
      ...
      let y = 250 - (Math.sin(angle) * 1500 - 250);
      return [
        new Laser(0, 500, Math.floor(x1), Math.floor(y), 1000, 250),
  ...
  [
    function (player) {
      ...
      let y = 250 - (Math.sin(angle) * 1500 - 250);
      return [
        new Laser(1000, 500, Math.floor(x1), Math.floor(y), 1000, 250),
  ...
  [
    ...
    1,
    1250,
  ], // Initialize Counter 3 + Break
  [
    function (player) {
      counter3++;
      return [
        new Laser(counter3 * 25, 0, counter3 * 25, 500, 500, counter3 * 25),
        new Pellet(1000, Math.floor(Math.random() * 500), [-3, 0]),
      ];
    },
    50,
  ...
  [
    function (player) {
      return [
        new Laser(500, 0, 500, 500, 1000, 100),
  ...
  [
    function (player) {
      return [
        new Laser(0, 0, 1000, 500, 1000, 100),
        new Laser(0, 500, 1000, 0, 1000, 100),
      ];
    },
    1000,
    5000,
  ], // Rest of lyrics fades out
];
